...
import bpeGraph from './images/bpe-graph.png'
...
<img src={bpeGraph.src} alt="Distribution of domain name lengths" width={bpeGraph.width} height={bpeGraph.height} />
...
<Bookmark
  name="preprocess.ipynb at main · jgeofil/transformers"
  url="https://github.com/jgeofil/transformers/blob/main/projects/domains/preprocess.ipynb"
/>
<Bookmark
  name="Hugging Face Tokenizer Documentation"
